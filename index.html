...
<head>
    ...
    <meta name="description" content="This is a cuda psd to html templete for cuda awesome website hopefully you can enjoy now...">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>CUDA | Awesome Design..</title>
    <!-- GOOGLE FONTS -->
    ...
    <link rel="stylesheet" href="resoursces/css/responsive.css">
</head>
<body>
    ...
    <header id="home">
        <nav>
            <div class="row">
                <a href="#home">
                    <img src="resoursces/img/logo.png" alt="CUDA" class="logo">
                </a>
                <ul class="main-nav">
    ...
    <section class="services-section js--services-section" id="service">
        ...
        <div class="row">
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/flag.png" alt="Flag" class="services-icon">
                <h3>Branding</h3>
                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/crayon.png" alt="Crayon" class="services-icon">
                <h3>Design</h3>
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem lorem ipsum.</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/gears.png" alt="Gears" class="services-icon">
                <h3>Development</h3>
                <p>At vero eos et accusamus et iusto odio dignissimos qui blanditiis praesentium.</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/rocket.png" alt="Flag" class="services-icon">
    ...
    <section class="team-section" id="team">
        ...
        <div class="row">
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/1.jpg" alt="ANNE HATHAWAY" class="team-member">
                <h3>ANNE HATHAWAY</h3>
            ...
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/2.jpg" alt="Kate Upton" class="team-member">
                <h3>Kate Upton</h3>
                <span class="role">Creative Director</span>
                <p>Duis aute irure dolor in in voluptate velit esse cillum dolore fugiat nulla pariatur. Excepteur sint occaecat non diam proident.
                </p>
                <div class="social-link">
                    <ul>
                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/3.jpg" alt="Ashley Greene" class="team-member">
                <h3>Ashley Greene</h3>
            ...
            <div class="col span_1_of_4 box">
                <img src="resoursces/img/4.jpg" alt="ANNE HATHAWAY" class="team-member">
                <h3>ANNE HATHAWAY</h3>
                <span class="role">CEO / Marketing Guru</span>
                <p>Lorem ipsum dolor sit amet, 
                    consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna.
        ...
        <div class="row">
            ...
            <div class="row container">
                <div class="col span_1_of_2 mix apps box">
                    <img src="resoursces/img/portfolio1.png" alt="Isometric Perspective Mock-Up" class="portfolio-image">
                    <h4>Isometric Perspective Mock-Up</h4>
                </div>
                <div class="col span_1_of_2 mix apps web box">
                    <img src="resoursces/img/portfolio2.png" alt="Time Zone App UI" class="portfolio-image">
                    <h4>Time Zone App UI</h4>
                </div>
                <div class="col span_1_of_2 mix icons box">
                    <img src="resoursces/img/portfolio3.png" alt="Viro Media Players UI" class="portfolio-image">
                    <h4>Viro Media Players UI</h4>
                </div>
                <div class="col span_1_of_2 mix icons web box">
                    <img src="resoursces/img/portfolio4.png" alt="Blog / Magazine Flat UI Kit" class="portfolio-image">
                    <h4>Blog / Magazine Flat UI Kit</h4>
                </div>
            </div>
            <!--HIDE LOAD-MORE-PROJECTS
            <div class="row">
        ...
        <div class="row">
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resoursces/img/1.jpg" alt="Chanel Iman">
                </div>
            ...
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resoursces/img/2.jpg" alt="ADRIANA LIMA">
                </div>
                <div class="client-review">
            ...
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resoursces/img/3.jpg" alt="ANNE HATHAWAY">
                </div>
                <div class="client-review">
                    <p>“Vivamus luctus urna sed urna ultricies ac tempor dui sagittis. In condimentum facilisis porta.”</p>
                    <h3>ANNE HATHAWAY</h3>
            ...
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resoursces/img/4.jpg" alt="EMMA STONE">
                </div>
                <div class="client-review">
    ...
    <section class="contact-section" id="contact">
        ...
        <div class="row">
            <form action="https://formspree.io/bpinazmul18@gmail.com" method="POST">
                <div class="row">
    ...
    <!-- JS FONT AWESOME -->
    <script src="https://kit.fontawesome.com/e8c569ef19.js" crossorigin="anonymous"></script>
    <!-- JS SCRIPT --> 
